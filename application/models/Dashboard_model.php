<?php
  ...
  ifnull((SELECT SUM(jml_penumpang) FROM (booking)WHERE((Month(tgl_booking)=1)AND (YEAR(tgl_booking)=$thn))),0) AS `Januari`,
  ifnull((SELECT SUM(jml_penumpang) FROM (booking)WHERE((Month(tgl_booking)=2)AND (YEAR(tgl_booking)=$thn))),0) AS `Februari`,
  ifnull((SELECT SUM(jml_penumpang) FROM (booking)WHERE((Month(tgl_booking)=3)AND (YEAR(tgl_booking)=$thn))),0) AS `Maret`,
  ifnull((SELECT SUM(jml_penumpang) FROM (booking)WHERE((Month(tgl_booking)=4)AND (YEAR(tgl_booking)=$thn))),0) AS `April`,
  ifnull((SELECT SUM(jml_penumpang) FROM (booking)WHERE((Month(tgl_booking)=5)AND (YEAR(tgl_booking)=$thn))),0) AS `Mei`,
  ifnull((SELECT SUM(jml_penumpang) FROM (booking)WHERE((Month(tgl_booking)=6)AND (YEAR(tgl_booking)=$thn))),0) AS `Juni`,
  ifnull((SELECT SUM(jml_penumpang) FROM (booking)WHERE((Month(tgl_booking)=7)AND (YEAR(tgl_booking)=$thn))),0) AS `Juli`,
  ifnull((SELECT SUM(jml_penumpang) FROM (booking)WHERE((Month(tgl_booking)=8)AND (YEAR(tgl_booking)=$thn))),0) AS `Agustus`,
  ifnull((SELECT SUM(jml_penumpang) FROM (booking)WHERE((Month(tgl_booking)=9)AND (YEAR(tgl_booking)=$thn))),0) AS `September`,
  ifnull((SELECT SUM(jml_penumpang) FROM (booking)WHERE((Month(tgl_booking)=10)AND (YEAR(tgl_booking)=$thn))),0) AS `Oktober`,
  ifnull((SELECT SUM(jml_penumpang) FROM (booking)WHERE((Month(tgl_booking)=11)AND (YEAR(tgl_booking)=$thn))),0) AS `November`,
  ifnull((SELECT SUM(jml_penumpang) FROM (booking)WHERE((Month(tgl_booking)=12)AND (YEAR(tgl_booking)=$thn))),0) AS `Desember`
